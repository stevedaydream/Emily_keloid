...
//
// 2026-08-12 兩項重要修正：
//   ① **正面／頭頸特寫改採解剖慣例**：面對病人時，病人的左（L't）畫在畫面右側。
//      舊座標是鏡像畫法（左畫在畫面左），與部長碼表的 L't/R't 語意相反，
//      22 碼裡有 9 組左右成對，錯一次就是永久錯，故全面對調。背面維持原向（背對時左就是左）。
//   ② **修掉一批系統性錯誤的四肢座標**：男女正面的前臂與手、女性肩膀、部分背面手腕/腳踝，
//      原本整組偏出人形輪廓（女性 front_hand 覆蓋率 0.0%、男性 1.9%，等於熱區浮在空白處）。
//      全部依 public/body-diagram/*.png 的逐列 alpha 掃描重新量測。
//      驗證方式：把每個熱區的像素與輪廓圖比對，132 個實例（66 熱區 × 男女）僅 2 個在 83%
//      （男性手部，受限於人形圖手指之間的縫隙，熱區本身確實落在手上）。
...
const BODY_ZONE_SHAPES_MALE: Record<string, ZoneShape> = {
  ...
  front_shoulder_l: { kind: "rect", x: 578, y: 200, w: 74, h: 62, rx: 18 },
  front_shoulder_r: { kind: "rect", x: 404, y: 200, w: 74, h: 62, rx: 18 },
  ...
  front_forearm_l: { kind: "rect", x: 656, y: 425, w: 32, h: 100, rx: 14 },
  front_forearm_r: { kind: "rect", x: 368, y: 425, w: 32, h: 100, rx: 14 },
  front_hand_l: { kind: "rect", x: 664, y: 566, w: 30, h: 36, rx: 10 },
  front_hand_r: { kind: "rect", x: 362, y: 566, w: 30, h: 36, rx: 10 },
  ...
  front_neck_side_l: { kind: "circle", cx: 550, cy: 170, r: 15 },
  front_neck_side_r: { kind: "circle", cx: 506, cy: 170, r: 15 },
  front_clavicle_l: { kind: "circle", cx: 576, cy: 238, r: 22 },
  front_clavicle_r: { kind: "circle", cx: 482, cy: 238, r: 22 },
  front_axilla_l: { kind: "circle", cx: 628, cy: 290, r: 26 },
  front_axilla_r: { kind: "circle", cx: 428, cy: 290, r: 26 },
  front_elbow_l: { kind: "circle", cx: 672, cy: 419, r: 26 },
  front_elbow_r: { kind: "circle", cx: 386, cy: 419, r: 26 },
  front_wrist_l: { kind: "circle", cx: 677, cy: 566, r: 20 },
  front_wrist_r: { kind: "circle", cx: 380, cy: 566, r: 20 },
  front_groin_l: { kind: "circle", cx: 580, cy: 566, r: 24 },
  front_groin_r: { kind: "circle", cx: 478, cy: 566, r: 24 },
  front_pubic: { kind: "circle", cx: 529, cy: 546, r: 26 },
  front_knee_l: { kind: "circle", cx: 603, cy: 884, r: 30 },
  front_knee_r: { kind: "circle", cx: 455, cy: 884, r: 30 },
  front_ankle_l: { kind: "circle", cx: 601, cy: 1010, r: 20 },
  front_ankle_r: { kind: "circle", cx: 456, cy: 1010, r: 20 },
  ...
  back_lower: { kind: "rect", x: 378, y: 544, w: 176, h: 56, rx: 16 },
  back_buttocks: { kind: "rect", x: 370, y: 604, w: 190, h: 58, rx: 22 },
  back_upperarm_l: { kind: "rect", x: 296, y: 395, w: 56, h: 145, rx: 20 },
  back_upperarm_r: { kind: "rect", x: 580, y: 395, w: 56, h: 145, rx: 20 },
  back_forearm_l: { kind: "rect", x: 299, y: 555, w: 32, h: 110, rx: 14 },
  back_forearm_r: { kind: "rect", x: 600, y: 555, w: 32, h: 110, rx: 14 },
  back_thigh_l: { kind: "rect", x: 368, y: 700, w: 76, h: 130, rx: 18 },
  back_thigh_r: { kind: "rect", x: 487, y: 700, w: 76, h: 130, rx: 18 },
  back_calf_l: { kind: "rect", x: 382, y: 890, w: 46, h: 100, rx: 16 },
  back_calf_r: { kind: "rect", x: 500, y: 890, w: 46, h: 100, rx: 16 },

  // 背面關節（2026-07-28）
  back_elbow_l: { kind: "circle", cx: 320, cy: 545, r: 26 },
  back_elbow_r: { kind: "circle", cx: 611, cy: 545, r: 26 },
  back_wrist_l: { kind: "circle", cx: 313, cy: 634, r: 13 },
  back_wrist_r: { kind: "circle", cx: 616, cy: 634, r: 13 },
  back_knee_l: { kind: "circle", cx: 401, cy: 890, r: 26 },
  back_knee_r: { kind: "circle", cx: 529, cy: 890, r: 26 },
  back_ankle_l: { kind: "circle", cx: 408, cy: 975, r: 14 },
  back_ankle_r: { kind: "circle", cx: 522, cy: 975, r: 14 },
...
const BODY_ZONE_SHAPES_FEMALE: Record<string, ZoneShape> = {
  // 正面（輪廓圖水平中心 cx=492）
  front_head: { kind: "circle", cx: 492, cy: 85, r: 44 },
  ...
  front_shoulder_l: { kind: "rect", x: 520, y: 215, w: 68, h: 60, rx: 18 },
  front_shoulder_r: { kind: "rect", x: 396, y: 215, w: 68, h: 60, rx: 18 },
  ...
  front_forearm_l: { kind: "rect", x: 602, y: 412, w: 32, h: 100, rx: 14 },
  front_forearm_r: { kind: "rect", x: 350, y: 412, w: 32, h: 100, rx: 14 },
  front_hand_l: { kind: "rect", x: 618, y: 552, w: 20, h: 60, rx: 8 },
  front_hand_r: { kind: "rect", x: 346, y: 552, w: 20, h: 60, rx: 8 },
  ...
  front_neck_side_l: { kind: "circle", cx: 514, cy: 195, r: 14 },
  front_neck_side_r: { kind: "circle", cx: 470, cy: 195, r: 14 },
  front_clavicle_l: { kind: "circle", cx: 529, cy: 242, r: 20 },
  front_clavicle_r: { kind: "circle", cx: 455, cy: 242, r: 20 },
  front_axilla_l: { kind: "circle", cx: 571, cy: 292, r: 24 },
  front_axilla_r: { kind: "circle", cx: 413, cy: 292, r: 24 },
  front_elbow_l: { kind: "circle", cx: 613, cy: 410, r: 22 },
  front_elbow_r: { kind: "circle", cx: 371, cy: 410, r: 22 },
  front_wrist_l: { kind: "circle", cx: 627, cy: 545, r: 12 },
  front_wrist_r: { kind: "circle", cx: 357, cy: 545, r: 12 },
  front_groin_l: { kind: "circle", cx: 540, cy: 556, r: 22 },
  front_groin_r: { kind: "circle", cx: 444, cy: 556, r: 22 },
  front_pubic: { kind: "circle", cx: 492, cy: 534, r: 24 },
  front_knee_l: { kind: "circle", cx: 539, cy: 855, r: 28 },
  front_knee_r: { kind: "circle", cx: 444, cy: 855, r: 28 },
  front_ankle_l: { kind: "circle", cx: 530, cy: 1005, r: 18 },
  front_ankle_r: { kind: "circle", cx: 454, cy: 1005, r: 18 },
  ...
  back_head: { kind: "circle", cx: 500, cy: 155, r: 45 },
  back_neck: { kind: "rect", x: 470, y: 195, w: 58, h: 60, rx: 14 },
  ...
  back_lower: { kind: "rect", x: 410, y: 548, w: 180, h: 56, rx: 16 },
  back_buttocks: { kind: "rect", x: 400, y: 610, w: 200, h: 55, rx: 22 },
  back_upperarm_l: { kind: "rect", x: 370, y: 400, w: 34, h: 105, rx: 14 },
  back_upperarm_r: { kind: "rect", x: 596, y: 400, w: 34, h: 105, rx: 14 },
  back_forearm_l: { kind: "rect", x: 356, y: 525, w: 24, h: 95, rx: 10 },
  back_forearm_r: { kind: "rect", x: 620, y: 525, w: 24, h: 95, rx: 10 },
  back_thigh_l: { kind: "rect", x: 415, y: 620, w: 75, h: 260, rx: 20 },
  back_thigh_r: { kind: "rect", x: 512, y: 620, w: 75, h: 260, rx: 20 },
  back_calf_l: { kind: "rect", x: 436, y: 890, w: 36, h: 95, rx: 14 },
  back_calf_r: { kind: "rect", x: 528, y: 890, w: 36, h: 95, rx: 14 },

  // 背面關節（2026-07-28）：女性背面手臂較短，止於 y≈680。
  back_elbow_l: { kind: "circle", cx: 378, cy: 525, r: 22 },
  back_elbow_r: { kind: "circle", cx: 622, cy: 525, r: 22 },
  back_wrist_l: { kind: "circle", cx: 367, cy: 630, r: 12 },
  back_wrist_r: { kind: "circle", cx: 633, cy: 630, r: 12 },
  back_knee_l: { kind: "circle", cx: 451, cy: 890, r: 24 },
  back_knee_r: { kind: "circle", cx: 549, cy: 890, r: 24 },
  back_ankle_l: { kind: "circle", cx: 459, cy: 1010, r: 12 },
  back_ankle_r: { kind: "circle", cx: 539, cy: 1010, r: 12 },
