...
- 匹茲堡睡眠品質量表 PSQI：24 道子題（含4題時間類用 text/number、9題睡眠困擾頻率單選、1題其他原因文字說明、4題整體評估單選、1題睡伴／室友狀況單選、4題睡伴觀察頻率單選、1題其他躁動情形文字說明）
...
**分段存檔**：`case_patient_intake_progress` 一段一列。SF-36 36 題＋PSQI 24 題＋病史區塊在門診很容易被打斷，最後才一次送出等於中途離開就全丟。重新打開從第一個未完成的段落接續。
